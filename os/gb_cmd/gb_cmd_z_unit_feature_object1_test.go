...
func Test_Command_NewFromObject_Help(t *testing.T) {
	gbtest.C(t, func(t *gbtest.T) {
		var (
			ctx      = gbctx.New()
			cmd, err = gbcmd.NewFromObject(&TestCmdObject{})
		)
		t.AssertNil(err)
...
func Test_Command_RootTag(t *testing.T) {
	gbtest.C(t, func(t *gbtest.T) {
		...
		cmd, err := gbcmd.NewFromObject(TestObjectForRootTag{})
		t.AssertNil(err)
...
func Test_Command_NeedArgs(t *testing.T) {
	gbtest.C(t, func(t *gbtest.T) {
		...
		cmd, err := gbcmd.NewFromObject(TestObjectForNeedArgs{})
		t.AssertNil(err)
...
func Test_Command_Pointer(t *testing.T) {
	gbtest.C(t, func(t *gbtest.T) {
		...
		cmd, err := gbcmd.NewFromObject(TestObjectPointerTag{})
		t.AssertNil(err)
...
func Test_Command_Orphan_Parameter(t *testing.T) {
	gbtest.C(t, func(t *gbtest.T) {
		var ctx = gbctx.New()
		cmd, err := gbcmd.NewFromObject(TestCommandOrphan{})
		t.AssertNil(err)
