...
func ExampleNew_Basic() {
	...
	t1 := gbtime.New(&timer)
	t2 := gbtime.New(curTime)
	t3 := gbtime.New(curTime, "Y-m-d H:i:s")
	t4 := gbtime.New(curTime)
	t5 := gbtime.New(1533686888)
...
func ExampleNew_WithFormat() {
	fmt.Println(gbtime.New("20220629133225", "YmdHis").Format("Y-m-d H:i:s"))
...
func ExampleNewFromTime() {
	...
	nTime := gbtime.NewFromTime(timer)
...
func ExampleNewFromStr() {
	t := gbtime.NewFromStr("2018-08-08 08:08:08")
...
func ExampleNewFromStrFormat() {
	t := gbtime.NewFromStrFormat("2018-08-08 08:08:08", "Y-m-d H:i:s")
	fmt.Println(t)
...
func ExampleNewFromStrLayout() {
	t := gbtime.NewFromStrLayout("2018-08-08 08:08:08", "2006-01-02 15:04:05")
	fmt.Println(t)
...
func ExampleNewFromTimeStamp() {
	t1 := gbtime.NewFromTimeStamp(1533686888)
	t2 := gbtime.NewFromTimeStamp(1533686888000)
...
func ExampleTime_Equal() {
	...
	gt2 := gbtime.New("2018-08-08 08:08:08")
...
func ExampleTime_Before() {
	gt1 := gbtime.New("2018-08-07")
	gt2 := gbtime.New("2018-08-08")
...
func ExampleTime_Sub() {
	gt1 := gbtime.New("2018-08-08 08:08:08")
	gt2 := gbtime.New("2018-08-08 08:08:10")
...
func ExampleTime_MarshalJSON() {
	type Person struct {
		...
		Birthday *gbtime.Time `json:"birthday"`
	}
	p := new(Person)
	p.Name = "goframe"
	p.Birthday = gbtime.New("2018-08-08 08:08:08")
	j, _ := json.Marshal(p)
