// Package gbcache provides kinds of cache management for process.
//
...
func Get(ctx context.Context, key interface{}) (*gbvar.Var, error) {
...
func GetOrSet(ctx context.Context, key interface{}, value interface{}, duration time.Duration) (*gbvar.Var, error) {
...
// It deletes the `key` if `duration` < 0 or given `value` is nil, but it does nothing
// if `value` is a function and the function result is nil.
func GetOrSetFunc(ctx context.Context, key interface{}, f Func, duration time.Duration) (*gbvar.Var, error) {
...
// writing mutex lock for concurrent safety purpose.
func GetOrSetFuncLock(ctx context.Context, key interface{}, f Func, duration time.Duration) (*gbvar.Var, error) {
...
func Remove(ctx context.Context, keys ...interface{}) (value *gbvar.Var, err error) {
...
func Update(ctx context.Context, key interface{}, value interface{}) (oldValue *gbvar.Var, exist bool, err error) {
...
func MustGet(ctx context.Context, key interface{}) *gbvar.Var {
	return defaultCache.MustGet(ctx, key)
}

// MustGetOrSet acts like GetOrSet, but it panics if any error occurs.
func MustGetOrSet(ctx context.Context, key interface{}, value interface{}, duration time.Duration) *gbvar.Var {
...
func MustGetOrSetFunc(ctx context.Context, key interface{}, f Func, duration time.Duration) *gbvar.Var {
...
func MustGetOrSetFuncLock(ctx context.Context, key interface{}, f Func, duration time.Duration) *gbvar.Var {
