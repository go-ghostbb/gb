...
func (c *Cache) MustGet(ctx context.Context, key interface{}) *gbvar.Var {
	v, err := c.Get(ctx, key)
	if err != nil {
		panic(err)
	}
...
func (c *Cache) MustGetOrSet(ctx context.Context, key interface{}, value interface{}, duration time.Duration) *gbvar.Var {
...
func (c *Cache) MustGetOrSetFunc(ctx context.Context, key interface{}, f Func, duration time.Duration) *gbvar.Var {
...
func (c *Cache) MustGetOrSetFuncLock(ctx context.Context, key interface{}, f Func, duration time.Duration) *gbvar.Var {
