...
type priorityQueue struct {
	...
	nextPriority *gbtype.Int64      // nextPriority stores the next priority value of the heap, which is used to check if necessary to call the Pop of heap by Timer.
}
...
func newPriorityQueue() *priorityQueue {
	queue := &priorityQueue{
		...
		nextPriority: gbtype.NewInt64(math.MaxInt64),
	}
