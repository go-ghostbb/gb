// Package gblist provides most commonly used doubly linked list container which also supports concurrent-safe/unsafe switch feature.
package gblist
...
func (l *List) Join(glue string) string {
	...
	if length > 0 {
		for i, e := 0, l.list.Front(); i < length; i, e = i+1, e.Next() {
			buffer.WriteString(gbconv.String(e.Value))
			if i != length-1 {
