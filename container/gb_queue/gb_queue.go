// Package gbqueue provides dynamic/static concurrent-safe queue.
//
// Features:
//
...
type Queue struct {
	...
	list   *gblist.List     // Underlying list structure for data maintaining.
	closed *gbtype.Bool     // Whether queue is closed.
