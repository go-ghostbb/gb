...
// GetVar returns a gbvar.Var with the value by given `key`.
// The returned gbvar.Var is un-concurrent safe.
func (tree *RedBlackTree) GetVar(key interface{}) *gbvar.Var {
	return gbvar.New(tree.Get(key))
}

// GetVarOrSet returns a gbvar.Var with result from GetVarOrSet.
// The returned gbvar.Var is un-concurrent safe.
func (tree *RedBlackTree) GetVarOrSet(key interface{}, value interface{}) *gbvar.Var {
	return gbvar.New(tree.GetOrSet(key, value))
}

// GetVarOrSetFunc returns a gbvar.Var with result from GetOrSetFunc.
// The returned gbvar.Var is un-concurrent safe.
func (tree *RedBlackTree) GetVarOrSetFunc(key interface{}, f func() interface{}) *gbvar.Var {
	return gbvar.New(tree.GetOrSetFunc(key, f))
}

// GetVarOrSetFuncLock returns a gbvar.Var with result from GetOrSetFuncLock.
// The returned gbvar.Var is un-concurrent safe.
func (tree *RedBlackTree) GetVarOrSetFuncLock(key interface{}, f func() interface{}) *gbvar.Var {
	return gbvar.New(tree.GetOrSetFuncLock(key, f))
}
...
func (tree *RedBlackTree) UnmarshalJSON(b []byte) error {
	...
	if tree.comparator == nil {
		tree.comparator = gbutil.ComparatorString
	}
...
func (tree *RedBlackTree) UnmarshalValue(value interface{}) (err error) {
	...
	for k, v := range gbconv.Map(value) {
		tree.doSet(k, v)
	}
	return
}
