...
func (m *IntAnyMap) GetVar(key int) *gbvar.Var {
	return gbvar.New(m.Get(key))
}

// GetVarOrSet returns a Var with result from GetVarOrSet.
// The returned Var is un-concurrent safe.
func (m *IntAnyMap) GetVarOrSet(key int, value interface{}) *gbvar.Var {
	return gbvar.New(m.GetOrSet(key, value))
}

// GetVarOrSetFunc returns a Var with result from GetOrSetFunc.
// The returned Var is un-concurrent safe.
func (m *IntAnyMap) GetVarOrSetFunc(key int, f func() interface{}) *gbvar.Var {
	return gbvar.New(m.GetOrSetFunc(key, f))
}

// GetVarOrSetFuncLock returns a Var with result from GetOrSetFuncLock.
// The returned Var is un-concurrent safe.
func (m *IntAnyMap) GetVarOrSetFuncLock(key int, f func() interface{}) *gbvar.Var {
...
func (m *IntAnyMap) UnmarshalValue(value interface{}) (err error) {
	...
	switch value.(type) {
	case string, []byte:
		return json.UnmarshalUseNumber(gbconv.Bytes(value), &m.data)
	default:
		for k, v := range gbconv.Map(value) {
			m.data[gbconv.Int(k)] = v
		}
	}
	return
}
