...
type ListMap struct {
	mu   rwmutex.RWMutex
	data map[interface{}]*gblist.Element
	list *gblist.List
}
...
func NewListMap(safe ...bool) *ListMap {
	return &ListMap{
		...
		data: make(map[interface{}]*gblist.Element),
		list: gblist.New(),
	}
}
...
func (m *ListMap) IteratorAsc(f func(key interface{}, value interface{}) bool) {
	...
	if m.list != nil {
		...
		m.list.IteratorAsc(func(e *gblist.Element) bool {
...
func (m *ListMap) IteratorDesc(f func(key interface{}, value interface{}) bool) {
	...
	if m.list != nil {
		var node *gListMapNode
		m.list.IteratorDesc(func(e *gblist.Element) bool {
			node = e.Value.(*gListMapNode)
			return f(node.key, node.value)
		})
	}
...
func (m *ListMap) Clear() {
	m.mu.Lock()
	m.data = make(map[interface{}]*gblist.Element)
	m.list = gblist.New()
	m.mu.Unlock()
}
...
func (m *ListMap) MapStrAny() map[string]interface{} {
	...
	if m.list != nil {
		...
		m.list.IteratorAsc(func(e *gblist.Element) bool {
			node = e.Value.(*gListMapNode)
			data[gbconv.String(node.key)] = node.value
			return true
		})
	}
	m.mu.RUnlock()
...
func (m *ListMap) GetVar(key interface{}) *gbvar.Var {
	return gbvar.New(m.Get(key))
}

// GetVarOrSet returns a Var with result from GetVarOrSet.
// The returned Var is un-concurrent safe.
func (m *ListMap) GetVarOrSet(key interface{}, value interface{}) *gbvar.Var {
	return gbvar.New(m.GetOrSet(key, value))
}

// GetVarOrSetFunc returns a Var with result from GetOrSetFunc.
// The returned Var is un-concurrent safe.
func (m *ListMap) GetVarOrSetFunc(key interface{}, f func() interface{}) *gbvar.Var {
	return gbvar.New(m.GetOrSetFunc(key, f))
}

// GetVarOrSetFuncLock returns a Var with result from GetOrSetFuncLock.
// The returned Var is un-concurrent safe.
func (m *ListMap) GetVarOrSetFuncLock(key interface{}, f func() interface{}) *gbvar.Var {
	return gbvar.New(m.GetOrSetFuncLock(key, f))
}
...
func (m *ListMap) Merge(other *ListMap) {
	...
	var node *gListMapNode
	other.list.IteratorAsc(func(e *gblist.Element) bool {
		node = e.Value.(*gListMapNode)
