...
type IGroupSortedSet interface {
	ZAdd(ctx context.Context, key string, option *ZAddOption, member ZAddMember, members ...ZAddMember) (*gbvar.Var, error)
	...
	ZRange(ctx context.Context, key string, start, stop int64, option ...ZRangeOption) (gbvar.Vars, error)
	ZRevRange(ctx context.Context, key string, start, stop int64, option ...ZRevRangeOption) (*gbvar.Var, error)
