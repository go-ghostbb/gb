...
func (r *Redis) GroupSet() gbredis.IGroupSet {
	return GroupSet{
...
func (r GroupSet) SPop(ctx context.Context, key string, count ...int) (*gbvar.Var, error) {
	var s = []interface{}{key}
	s = append(s, gbconv.Interfaces(count)...)
...
func (r GroupSet) SRandMember(ctx context.Context, key string, count ...int) (*gbvar.Var, error) {
	var s = []interface{}{key}
	s = append(s, gbconv.Interfaces(count)...)
...
func (r GroupSet) SMembers(ctx context.Context, key string) (gbvar.Vars, error) {
...
func (r GroupSet) SInter(ctx context.Context, key string, keys ...string) (gbvar.Vars, error) {
	var s = []interface{}{key}
...
func (r GroupSet) SUnion(ctx context.Context, key string, keys ...string) (gbvar.Vars, error) {
	var s = []interface{}{key}
	s = append(s, gbconv.Interfaces(keys)...)
...
func (r GroupSet) SDiff(ctx context.Context, key string, keys ...string) (gbvar.Vars, error) {
	var s = []interface{}{key}
	s = append(s, gbconv.Interfaces(keys)...)
