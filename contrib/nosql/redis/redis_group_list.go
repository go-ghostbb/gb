...
func (r *Redis) GroupList() gbredis.IGroupList {
	return GroupList{
...
func (r GroupList) LPop(ctx context.Context, key string, count ...int) (*gbvar.Var, error) {
	if len(count) > 0 {
...
func (r GroupList) RPop(ctx context.Context, key string, count ...int) (*gbvar.Var, error) {
	if len(count) > 0 {
...
func (r GroupList) LIndex(ctx context.Context, key string, index int64) (*gbvar.Var, error) {
...
func (r GroupList) LInsert(ctx context.Context, key string, op gbredis.LInsertOp, pivot, value interface{}) (int64, error) {
...
func (r GroupList) LSet(ctx context.Context, key string, index int64, value interface{}) (*gbvar.Var, error) {
...
func (r GroupList) LRange(ctx context.Context, key string, start, stop int64) (gbvar.Vars, error) {
...
func (r GroupList) BLPop(ctx context.Context, timeout int64, keys ...string) (gbvar.Vars, error) {
	v, err := r.Operation.Do(ctx, "BLPop", append(gbconv.Interfaces(keys), timeout)...)
	return v.Vars(), err
}
...
func (r GroupList) BRPop(ctx context.Context, timeout int64, keys ...string) (gbvar.Vars, error) {
	v, err := r.Operation.Do(ctx, "BRPop", append(gbconv.Interfaces(keys), timeout)...)
	return v.Vars(), err
}
...
func (r GroupList) RPopLPush(ctx context.Context, source, destination string) (*gbvar.Var, error) {
...
func (r GroupList) BRPopLPush(ctx context.Context, source, destination string, timeout int64) (*gbvar.Var, error) {
