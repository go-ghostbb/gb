...
func (r *Redis) GroupGeneric() gbredis.IGroupGeneric {
	return GroupGeneric{
...
func (r GroupGeneric) Copy(ctx context.Context, source, destination string, option ...gbredis.CopyOption) (int64, error) {
...
func (r GroupGeneric) Exists(ctx context.Context, keys ...string) (int64, error) {
	v, err := r.Operation.Do(ctx, "Exists", gbconv.Interfaces(keys)...)
	return v.Int64(), err
}
...
func (r GroupGeneric) Unlink(ctx context.Context, keys ...string) (int64, error) {
	v, err := r.Operation.Do(ctx, "Unlink", gbconv.Interfaces(keys)...)
	return v.Int64(), err
}
...
func (r GroupGeneric) Del(ctx context.Context, keys ...string) (int64, error) {
	v, err := r.Operation.Do(ctx, "Del", gbconv.Interfaces(keys)...)
	return v.Int64(), err
}
...
func (r GroupGeneric) FlushDB(ctx context.Context, option ...gbredis.FlushOp) error {
	_, err := r.Operation.Do(ctx, "FlushDB", gbconv.Interfaces(option)...)
	return err
}
...
func (r GroupGeneric) FlushAll(ctx context.Context, option ...gbredis.FlushOp) error {
	_, err := r.Operation.Do(ctx, "FlushAll", gbconv.Interfaces(option)...)
	return err
}
...
func (r GroupGeneric) Expire(ctx context.Context, key string, seconds int64, option ...gbredis.ExpireOption) (int64, error) {
	var usedOption interface{}
	if len(option) > 0 {
		usedOption = option[0]
	}
...
func (r GroupGeneric) ExpireAt(ctx context.Context, key string, time time.Time, option ...gbredis.ExpireOption) (int64, error) {
	var usedOption interface{}
	if len(option) > 0 {
		usedOption = option[0]
	}
	v, err := r.Operation.Do(ctx, "ExpireAt", mustMergeOptionToArgs(
		[]interface{}{key, gbtime.New(time).Timestamp()}, usedOption,
	)...)
	return v.Int64(), err
}
...
func (r GroupGeneric) ExpireTime(ctx context.Context, key string) (*gbvar.Var, error) {
...
func (r GroupGeneric) PExpire(ctx context.Context, key string, milliseconds int64, option ...gbredis.ExpireOption) (int64, error) {
	var usedOption interface{}
	if len(option) > 0 {
		usedOption = option[0]
	}
...
func (r GroupGeneric) PExpireAt(ctx context.Context, key string, time time.Time, option ...gbredis.ExpireOption) (int64, error) {
	var usedOption interface{}
	if len(option) > 0 {
		usedOption = option[0]
	}
	v, err := r.Operation.Do(ctx, "PExpireAt", mustMergeOptionToArgs(
		[]interface{}{key, gbtime.New(time).TimestampMilli()}, usedOption,
	)...)
	return v.Int64(), err
}
...
func (r GroupGeneric) PExpireTime(ctx context.Context, key string) (*gbvar.Var, error) {
