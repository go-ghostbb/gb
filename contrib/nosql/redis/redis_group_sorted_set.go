...
func (r *Redis) GroupSortedSet() gbredis.IGroupSortedSet {
...
func (r GroupSortedSet) ZAdd(
	ctx context.Context, key string, option *gbredis.ZAddOption, member gbredis.ZAddMember, members ...gbredis.ZAddMember,
) (*gbvar.Var, error) {
...
func (r GroupSortedSet) ZRange(ctx context.Context, key string, start, stop int64, option ...gbredis.ZRangeOption) (gbvar.Vars, error) {
...
func (r GroupSortedSet) ZRevRange(ctx context.Context, key string, start, stop int64, option ...gbredis.ZRevRangeOption) (*gbvar.Var, error) {
	var usedOption interface{}
	if len(option) > 0 {
		usedOption = option[0]
	}
