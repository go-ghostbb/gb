...
func (r *Redis) GroupHash() gbredis.IGroupHash {
	return GroupHash{
...
func (r GroupHash) HGet(ctx context.Context, key, field string) (*gbvar.Var, error) {
...
func (r GroupHash) HDel(ctx context.Context, key string, fields ...string) (int64, error) {
	v, err := r.Operation.Do(ctx, "HDel", append([]interface{}{key}, gbconv.Interfaces(fields)...)...)
	return v.Int64(), err
}
...
func (r GroupHash) HMGet(ctx context.Context, key string, fields ...string) (gbvar.Vars, error) {
	v, err := r.Operation.Do(ctx, "HMGet", append([]interface{}{key}, gbconv.Interfaces(fields)...)...)
	return v.Vars(), err
}
...
func (r GroupHash) HVals(ctx context.Context, key string) (gbvar.Vars, error) {
...
func (r GroupHash) HGetAll(ctx context.Context, key string) (*gbvar.Var, error) {
