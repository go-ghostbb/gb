...
func (r *Redis) GroupString() gbredis.IGroupString {
	return GroupString{
...
func (r GroupString) Set(ctx context.Context, key string, value interface{}, option ...gbredis.SetOption) (*gbvar.Var, error) {
...
func (r GroupString) Get(ctx context.Context, key string) (*gbvar.Var, error) {
...
func (r GroupString) GetDel(ctx context.Context, key string) (*gbvar.Var, error) {
...
func (r GroupString) GetEX(ctx context.Context, key string, option ...gbredis.GetEXOption) (*gbvar.Var, error) {
	var usedOption interface{}
	if len(option) > 0 {
		usedOption = option[0]
	}
...
func (r GroupString) GetSet(ctx context.Context, key string, value interface{}) (*gbvar.Var, error) {
...
func (r GroupString) MGet(ctx context.Context, keys ...string) (map[string]*gbvar.Var, error) {
	var result = make(map[string]*gbvar.Var)
	v, err := r.Operation.Do(ctx, "MGet", gbconv.Interfaces(keys)...)
	if err == nil {
		values := v.Vars()
