// Package gbtag providing tag content storing for struct.
//
...
const (
	...
	GBConv            = "gbconv"       // GConv defines the converting target name for specified struct field.
	GBConvShort       = "c"            // GConv defines the converting target name for specified struct field.
