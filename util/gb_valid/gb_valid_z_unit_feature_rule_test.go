...
func Test_InternalError_String(t *testing.T) {
	gbtest.C(t, func(t *gbtest.T) {
		...
		t.Assert(gberror.Current(err), "InvalidRules: hh")
	})
}
...
func Test_Code(t *testing.T) {
	gbtest.C(t, func(t *gbtest.T) {
		...
		t.AssertNE(err, nil)
		t.Assert(gberror.Code(err), gbcode.CodeValidationFailed)
	})

	gbtest.C(t, func(t *gbtest.T) {
		err := g.Validator().Rules("none-exist-rule").Data("").Run(ctx)
		t.AssertNE(err, nil)
		t.Assert(gberror.Code(err), gbcode.CodeInternalError)
	})
}
...
func Test_After(t *testing.T) {
	...
	gbtest.C(t, func(t *gbtest.T) {
		type Params struct {
			T1 *gbtime.Time `v:"after:T2"`
			T2 *gbtime.Time
		}
		obj := &Params{
			T1: gbtime.New("2022-09-02"),
			T2: gbtime.New("2022-09-01"),
		}
		err := g.Validator().Data(obj).Run(ctx)
		t.AssertNil(err)
	})
	gbtest.C(t, func(t *gbtest.T) {
		...
		obj := &Params{
			T1: gbtime.New("2022-09-01"),
			T2: gbtime.New("2022-09-02"),
		}
		err := g.Validator().Data(obj).Run(ctx)
...
func Test_After_Equal(t *testing.T) {
	...
	gbtest.C(t, func(t *gbtest.T) {
		type Params struct {
			T1 *gbtime.Time `v:"after-equal:T2"`
			T2 *gbtime.Time
		}
		obj := &Params{
			T1: gbtime.New("2022-09-02"),
...
func Test_Before_Equal(t *testing.T) {
	...
	gbtest.C(t, func(t *gbtest.T) {
		type Params struct {
			T1 *gbtime.Time `v:"before-equal:T2"`
			T2 *gbtime.Time
		}
		obj := &Params{
			T1: gbtime.New("2022-09-01"),
...
func Test_Enums(t *testing.T) {
	gbtest.C(t, func(t *gbtest.T) {
		...
		t.AssertNil(err)
		defer t.AssertNil(gbtag.SetGlobalEnums(oldEnumsJson))

		err = gbtag.SetGlobalEnums(`{"ghostbb.io/gb/util/gb_valid_test.EnumsTest": ["a","b"]}`)
		t.AssertNil(err)
