...
func Test_Struct_Attr_CustomType2(t *testing.T) {
	...
	gbtest.C(t, func(t *gbtest.T) {
		user := new(User)
		err := gbconv.Struct(g.Map{"id": g.Slice{1, 2}, "name": "john"}, user)
		t.AssertNil(err)
...
func Test_Struct_Attr_CustomType3(t *testing.T) {
	...
	gbtest.C(t, func(t *gbtest.T) {
		config := new(Config)
		err := gbconv.Struct(g.Map{"d": "15s"}, config)
		t.AssertNil(err)
...
func Test_StructEmbedded4(t *testing.T) {
    ...
    "sub": {
		...
		tx := new(Test)
		if err := gbconv.Struct(data, &tx); err != nil {
			panic(err)
		}
		t.Assert(tx, expect)
	})
...
func Test_Struct_GTime(t *testing.T) {
	...
	gbtest.C(t, func(t *gbtest.T) {
		...
		var user *User
		err := gbconv.Struct(`{"Name":"John","CreateTime":""}`, &user)
		t.AssertNil(err)
		t.AssertNE(user, nil)
		t.Assert(user.Name, `John`)
...
func Test_Struct_Slice(t *testing.T) {
	gbtest.C(t, func(t *gbtest.T) {
		...
		user := new(User)
		array := g.Slice{1, 2, 3}
		err := gbconv.Struct(g.Map{"scores": array}, user)
		t.AssertNil(err)
...
func Test_Struct_To_Struct(t *testing.T) {
	...
	gbtest.C(t, func(t *gbtest.T) {
		t.Assert(gbconv.Struct(TestB, &TestA), nil)
...
func Test_Struct_JsonParam(t *testing.T) {
	...
	gbtest.C(t, func(t *gbtest.T) {
		var a = A{}
		err := gbconv.Struct([]byte(`{"id":1,"name":"john"}`), &a)
		t.AssertNil(err)
		t.Assert(a.Id, 1)
	...
	gbtest.C(t, func(t *gbtest.T) {
		var (
			...
			data = g.Map{
				"id":     100,
				"name":   "john",
				"status": gbvar.New(false),
			}
		)
		err := gbconv.Struct(data, &a)
		t.AssertNil(err)
...
func Test_Struct_Empty_MapStringString(t *testing.T) {
	gbtest.C(t, func(t *gbtest.T) {
		...
		var (
			s   = &S{}
			err = gbconv.Struct(map[string]string{}, s)
		)
		t.AssertNil(err)
	})
}
...
func Test_Struct_Issue1597(t *testing.T) {
	gbtest.C(t, func(t *gbtest.T) {
		...
		data, err := gbjson.DecodeToJson(jsonByte)
		t.AssertNil(err)
		s := &S{}
		err = data.Scan(s)
		t.AssertNil(err)
...
func Test_Struct_Issue2980(t *testing.T) {
	...
	gbtest.C(t, func(t *gbtest.T) {
		date := gbtime.New("2023-09-22 12:00:00").UTC()
		params := g.Map{
			"CreatedAt": gbtime.New("2023-09-22 12:00:00").UTC(),
			"UserName":  "Galileo",
		}
		postWithUser := new(PostWithUser)
		err := gbconv.Scan(params, postWithUser)
		t.AssertNil(err)
...
func Test_Scan_WithDoubleSliceAttribute(t *testing.T) {
	...
	gbtest.C(t, func(t *gbtest.T) {
		jv := gbjson.New(gbjson.MustEncodeString(data))
		err := jv.Scan(&data)
		t.AssertNil(err)
...
func Test_Struct_WithCustomType(t *testing.T) {
	...
	var (
		params = gbconv.Map(`{"PayMode": 1000}`)
		req1   *Req1
		req2   *Req2
		err1   error
		err2   error
	)
	err1 = gbconv.Struct(params, &req1)
	err2 = gbconv.Struct(params, &req2)
	gbtest.C(t, func(t *gbtest.T) {
		t.AssertNil(err1)
