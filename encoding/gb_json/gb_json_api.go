...
// Var returns the json value as *gbvar.Var.
func (j *Json) Var() *gbvar.Var {
	return gbvar.New(j.Interface())
}
...
func (j *Json) Get(pattern string, def ...interface{}) *gbvar.Var {
	if j == nil {
		return nil
	}
	j.mu.RLock()
...
func (j *Json) Append(pattern string, value interface{}) error {
	...
	return gberror.NewCodef(gbcode.CodeInvalidParameter, "invalid variable type of %s", pattern)
}
